...
public class ProductService implements IProductService {
	...
	private Product createProduct(ProductRequest productRequest, Category category) {
		...
		return new Product(productRequest.getName(), productRequest.getBrand(), productRequest.getDescription(),
				productRequest.getPrice(), productRequest.getInventory(), category);
	}
	...
	public List<ProductDto> getProductsByBrandAndCategory(String brand, String category) {
		...
		List<ProductDto> convertedProducts = this
				.getConvertedProducts(productRepository.findByCategoryNameAndBrand(category, brand));
		return convertedProducts;
	}
